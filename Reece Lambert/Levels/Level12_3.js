function rlLevel12_3() {

	this.update = rl_level12_3_update;
	this.draw = rl_level12_3_draw;

	this.click = rl_level12_3_click;
    this.mouseMove = rl_level12_3_mouse_move;
...
function rl_level12_3_update(){

}

function rl_level12_3_draw(ctx){
...
function rl_level12_3_click(x, y){

	console.log("Clicked at: " + x + ", " + y);
	if(this.button1.hitTest(x, y)){
		console.log("Changing Level..");
		return new rlLevel12_4();
	}
...
function rl_level12_3_mouse_move(x, y){
