function rlLevel30() {
	...
	this.update = rl_level30_update;
	this.draw = rl_level30_draw;

	this.click = rl_level30_click;
    this.mouseMove = rl_level30_mouse_move;

	this.firstButtonHighlighted = false;

	this.button1 = new Button(75,300,275,80, "You can");
	...
	this.circle = new Circle (50,50,50,50,"30");
}

function rl_level30_update(){
	
}

function rl_level30_draw(ctx){
...
function rl_level30_click(x, y){

	console.log("Clicked at: " + x + ", " + y);
	if(this.button1.hitTest(x, y)){
		console.log("Changing level...");
		return new rlSuccess();
	}
...
function rl_level30_mouse_move(x, y){
